                ...
                <div class="max-w-md mx-auto">
                    ...
                    <div class="divide-y divide-gray-200">
                        <form class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <div class="relative">
                                <input autocomplete="off" v-model="password" id="password" name="password"
                                    type="password"
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            ...
                            <div class="relative">
                                <input autocomplete="off" v-model="confirmPassword" id="password_confirmation"
                                ...
                                <div v-if="validationErrors.password_confirmation" class="flex flex-col">
                                    <small class="text-theme-danger-500">
